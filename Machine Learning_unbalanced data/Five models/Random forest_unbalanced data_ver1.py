# -*- coding: utf-8 -*-
"""
Created on Sun Apr 17 10:17:16 2022
...
def ks_calc_auc(x_test,y_test):
     ...
     '''
     decision_scores = forest.predict_proba(x_test)
...
# print("precision rate: " + str(forest.score(x_test,y_test)))
...
#     # 阈值移动
# y_pred1 = forest.predict_proba(x_test)
# yy = y_pred1[:, 1]
...
print("precision rate_1: " + str(forest.score(x1_test, y1_test)))
a = pd.crosstab( y1_true , y1_pred)
print("1_precision rate_1:" + str(a[1][1]/(a[0][1]+a[1][1])))
print("ks_1:" + str(ks1))
    
    # 绘制AUC曲线，并求出面积
decision_scores1 = forest.predict_proba(x1_test)
...
plt.show()
    ...
    # 绘制lift曲线
proba1 = forest.predict_proba(x1_test)
...
# forest.fit(x_smote_resampled, y_smote_resampled)
#
#     # 找出混淆矩阵
...
# print("precision rate_2: " + str(forest.score(x2_test, y2_test)))
# a = pd.crosstab( y2_true , y2_pred)
# print("1_precision rate_2:" + str(a[1][1]/(a[0][1]+a[1][1])))
# print("ks_2:" + str(ks2))
#
#     # 绘制AUC曲线，并求出面积
# decision_scores2 = forest.predict_proba(x2_test)
...
#
#     # 绘制lift曲线
# proba2 = forest.predict_proba(x2_test)
